...
class RoverCommandCentre(Node):
    ...
    def launch_manual_control(self):
        ...
        manual_control_nodes = ['manual_control', 'gps', 'obstacle_detection', 'csi_camera_1', 'rover', 'usb_camera']
    ...
    def stop_all_rover_nodes(self):
        ...
        nodes_to_stop = ['gps', 'rover', 'csi_camera_1', 'obstacle_detection', 'manual_control', 'usb_camera']
